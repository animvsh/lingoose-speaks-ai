        ...
        <>
          ...
          <div className="bg-blue-50 rounded-xl p-3 border-2 border-blue-200">
            <p className="text-xs text-blue-800 font-medium">
              💡 Test notifications use FCM integration. Notifications will appear as push notifications on your device.
            </p>
          </div>
          
          <div className="bg-yellow-50 rounded-xl p-3 border-2 border-yellow-200">
            <p className="text-xs text-yellow-800 font-medium">
              🔧 Demo Mode: This implementation uses simplified tokens. In production, this would use proper FCM integration with Firebase.
            </p>
          </div>
        </>
      )}
...
export default FCMNotificationsPanel;