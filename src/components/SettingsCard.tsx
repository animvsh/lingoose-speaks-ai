        ...
        <div className="w-full space-y-6">
          ...
          <div className="w-full rounded-3xl border-2 border-handdrawn bg-white/90 p-6 shadow-lg">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between py-4 px-4 bg-indigo-50 rounded-2xl border-2 border-indigo-200 cursor-pointer hover:bg-indigo-100 transition-all duration-200 hover:scale-[1.02]" onClick={() => {
                console.log('🎯 System Prompt Settings clicked');
                handleNavigationClick("system-prompt-settings", "system_prompt_settings");
              }}>
                <div className="flex items-center">
