    ...
    <div className="min-h-screen bg-yellow-100">
      <div className="px-4 pt-6">
        ...
        <Button 
          ...
          className="w-full bg-orange-400 hover:bg-orange-500 border-4 border-orange-600 text-white font-black py-6 px-6 rounded-2xl text-lg transition-all duration-200 hover:scale-105 transform hover:-rotate-1 mb-8"
        >
